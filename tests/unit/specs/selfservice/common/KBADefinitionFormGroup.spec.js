...
describe("KBADefinitionFormGroup Component", () => {
  ...
  it.skip("disables questions when they are selected", () => {
  ...
  it.skip('adds "question" input when custom option is selected', () => {
  ...
  it("correctly formats save object", () => {
    const options = Object.assign({}, mountOptions, { stubs: ["BFormSelect"] }),
  ...
  it("allows selecting defined questions", () => {
    ...
    wrapper.vm.selected = [{ selected: "1" }, { selected: "2" }];
