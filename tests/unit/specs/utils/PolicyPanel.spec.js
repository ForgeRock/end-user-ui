...
describe("PolicyPanel.vue", () => {
  ...
  describe("proper render", () => {
    ...
    it.skip('should not show anything when "policyFailures" is loading', () => {
    ...
    it.skip('should show policy ul when "policyFailures" is non empty array', () => {
    ...
    it.skip('should show success alert when "policyFailures" is an empty array', () => {
  ...
  describe("#translate", () => {
    ...
    it("should return a properly translated string", () => {
      ...
      expect(
        wrapper.vm.translate({ name: "MIN_LENGTH", params: { minLength: 1 } })
