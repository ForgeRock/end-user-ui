          ...
          <b-list-group flush>
            ...
            >
              <div class="d-sm-flex">
                  ...
                  <div class="media mb-2 mb-sm-0">
                    <div class="d-flex mr-3 align-self-top">
                      <fr-fallback-image
                        ...
                        :height="40"
                        :width="40"
                        fallback="fa-file-o fa-2x m-auto pt-1 pb-1"
                      ></fr-fallback-image>
                    </div>
                ...
                <div
                  class="d-flex justify-content-start justify-content-sm-start ml-sm-3 align-self-center"
                >
                  <div class="d-sm-none">
                    <a
                      href="#"
                      ...
                      >{{ $t("pages.uma.resources.share") }}</a
                    >
                    <a
                      href="#"
                      class="align-self-center pr-3"
                      @click="renderUnshareModal(resource.name, resource._id)"
                      >{{ $t("pages.uma.resources.unshare") }}</a
                    >
                  </div>
                  <div class="d-none d-sm-flex">
                    ...
                    <a
                      ...
                      v-if="
                        resource.policy &&
                        resource.policy.permissions.length > 0
                      "
                      class="align-self-center pr-3"
                      @click="renderUnshareModal(resource.name, resource._id)"
                      >{{ $t("pages.uma.resources.unshare") }}</a
            ...
            <div class="card text-center mb-4">
              <div class="card-header py-0 px-1 border-0">
                ...
                >
                  ...
                  <b-dropdown-item
                    href="#"
                    @click="renderShareModal(resource)"
                    >{{ $t("pages.uma.resources.share") }}</b-dropdown-item
                  >
                  <b-dropdown-item
                    href="#"
                    @click="renderUnshareModal(resource.name, resource._id)"
                    >{{ $t("pages.uma.resources.unshare") }}</b-dropdown-item
                  >
                </b-dropdown>
              </div>
              <div class="card-body pt-0">
                <fr-fallback-image
                  ...
                  fallback="fa-file-o fa-3x m-auto pt-3 pb-3"
                ></fr-fallback-image>
    ...
    filteredResources() {
      if (this.resourceFilter.length > 0) {
        return this.resources.filter((resource) => {
          resource.name.includes(this.resourceFilter);
        });
      }
