      ...
      <template slot="list-item-header" class="overflow:hidden;">
        ...
        <div class="d-flex align-self-right">
          ...
          >
            {{
              $t(
                `pages.profile.consent.${mapping.consented ? "deny" : "allow"}`
              )
            }}
          </b-button>
        ...
        >
          ...
          <b-container>
            <p
              ...
              v-html="
                $t('pages.profile.consent.confirmDeny', {
          ...
          <div slot="modal-footer">
            <div class="float-right">
              ...
              >
                {{
                  $t(
                    `pages.profile.consent.${
                      mapping.consented ? "deny" : "allow"
                    }`
                  )
                }}
              </b-btn>
  ...
  computed: {
    mappings() {
      return this.consentableMappings.map((mapping) => {
        let consentedMapping = _.find(this.consentedMappings, {
        ...
        if (!_.isUndefined(consentedMapping)) {
          ...
          mapping.subTitle = `${this.$t(
            "pages.profile.consent.authorized"
          )} ${moment(mapping.consentDate).format("MMMM Do YYYY")}`;
        } else {
