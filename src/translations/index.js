  ...
  en: {
    ...
    common: {
      ...
      policyValidationMessages: {
        ...
        CANNOT_CONTAIN_CHARACTERS:
          "Cannot contain characters: %{forbiddenChars}",
        IS_NUMBER: "Must be a number greater than or equal to zero.",
        IS_NUMBER_GREATER_ZERO: "Must be a number greater than or equal to 1.",
        REQUIRED: "Cannot be blank",
        VALID_DATE: "Must be a valid date",
        VALID_TYPE:
          "Must be one of the following types: %{validTypes}. Cannot be %{invalidType}",
        MATCH_REGEXP: "Has to match pattern: %{regexp}",
        PRIVILEGE_AT_LEAST_ONE_ATTRIBUTE_READONLY_FALSE:
          "Must set at least one attribute permission to Read/Write",
        PRIVILEGE_MUST_CONTAIN_CREATE_OR_UPDATE_PERMISSION:
          "Must have at least Create or Update Permission",
        MIN_LENGTH: "Must be %{minLength} characters long",
        AT_LEAST_X_CAPITAL_LETTERS:
          "Must have at least %{numCaps} capital letter(s)",
        AT_LEAST_X_NUMBERS: "Must have at least %{numNums} number(s)",
        CANNOT_CONTAIN_OTHERS:
          "Must not share characters with %{disallowedFields}",
        VALID_EMAIL_ADDRESS_FORMAT:
          "Invalid email format (example@example.com)",
        IS_NEW:
          "Must not be the same as the previous %{historyLength} passwords",
    ...
    pages: {
      ...
      dashboard: {
        ...
        noWidgetSubText:
          'Don\'t worry, you still have a <a href="/#/profile">profile</a>.',
        widgets: {
          welcome: {
            greeting: "Hello",
            welcomeMessage:
              "The ForgeRock End User UI helps users manage their account data, consent, workflows, and shared resources.",
      ...
      login: {
        ...
        recoverUsername: "recover your username.",
      ...
      selfservice: {
        signIn: "Sign in",
        captchaError:
          "ReCaptcha configured improperly - contact your administrator.",
        headers: {
          username: {
            title: "Recover Your Username",
            description:
              "You can recover your username with the email address associated with your account.",
          },
          reset: {
        ...
        accountClaiming: {
          ...
          passwordDesc:
            "To continue, please sign in with you email <strong>{account}</strong> to link accounts.",
          socialDesc:
            "To continue, please sign in to your {providers} account to link accounts.",
          link: "Link Accounts",
        ...
        forgotUsername: {
          ...
          emailSent:
            "An email containing your username has been sent to your account.",
        },
        passwordReset: {
          ...
          kbaVerificationStageDescription:
      ...
      profile: {
        ...
        oauthApplications: {
          ...
          removeConfirmation:
            'Are you sure you want to remove "{applicationName}" from your list of authorized applications?',
        ...
        trustedDevices: {
          ...
          removeConfirmation:
            'Are you sure you want to remove "{deviceName}" from your list of trusted devices?',
        ...
        accountSecurity: {
          ...
          subtitle:
            "Update your username, password or security questions to secure your account.",
          password: "Password",
        ...
        consent: {
          ...
          confirmDeny:
            "<strong>{mappingName}</strong> will no longer have access to your data.",
          deny: "Deny",
        ...
        socialSignIn: {
          ...
          disconnectConfirmMsg:
            "If you disconnect, you will not be able to log in with {provider}.",
          connect: "Connect",
      ...
      uma: {
        activity: {
          ...
          Authorisation_Request_Denied:
            "You denied the request from {requestingParty} to access",
          Authorisation_Request_Approved:
            "You approved the request from {requestingParty} to access",
        ...
        resources: {
          ...
          sameShareError:
            "Cannot reshare resource with {requestingParty}.  Unshare with requesting party before changing permissions",
      ...
      access: {
        ...
        typeToSearchFor: "Type to search for {resource}",
        typeAtLeastToSearchFor:
          "Type at least {numChars} characters to search for {resource}",
        typeAndEnterToSearch: "Type and press enter to search",
        typeAtLeastAndEnterToSearch:
          "Type at least {numChars} characters and press enter to search",
