                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <router-link :to="{ name: 'Dashboard'}">
                            <i class="fa fa-fw mr-3 fa-tachometer-alt" />
                            <span class="sidebar-item-text">{{ $t('pages.app.dashboard') }}</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'Profile'}">
                            <i class="fa fa-fw mr-3 fa-street-view" />
                            <span class="sidebar-item-text">{{ $t('pages.app.profile') }}</span>
                        </router-link>
                    </li>
                    <li
                        v-if="$root.applicationStore.state.amDataEndpoints && this.$root.userStore.state.internalUser === false"
                    >
                        <router-link :to="{ name: 'Sharing'}">
                            <i class="fa fa-fw mr-3 fa-share" />
                            <span class="sidebar-item-text">{{ $t('pages.app.sharing') }}</span>
                        </router-link>
                    </li>
                    <template v-for="(access, index) in this.$root.userStore.state.access">
                        <li :key="'accessResource' +index">
                            ...
                            >
                                <i :class="accessIcon(access.icon)" />
                                <span class="sidebar-item-text">{{ access.title }}</span>
                            </router-link>
                        </li>
                    </template>
                </ul>
            ...
            <template slot="body" slot-scope="props">
                ...
                >
                    ...
                    <div class="fr-alert-content align-self-center">
                        <p class="mb-0 text-left" v-html="props.item.text" />
                    </div>
